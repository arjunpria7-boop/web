    ...
    <div className="min-h-screen text-white font-sans flex flex-col">
      ...
      <div className="relative z-10 flex flex-col flex-grow">
        ...
        <main className="container mx-auto p-4 md:p-8 flex-grow">
          ...
          <div className="w-full max-w-2xl mx-auto p-6 mt-12 bg-slate-900/40 border border-slate-700/50 rounded-lg backdrop-blur-md text-center">
            ...
            <a
              ...
              className="mt-4 inline-block bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold py-3 px-8 rounded-full hover:from-purple-600 hover:to-pink-600 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Daftar Sekarang
            </a>
          </div>
